...
const Int_t DIA_OFFSET2006 = 7; // 0 is usual but 7 is needed for 2006 data

const int SILICON_MEM2006 = 2048; //Number of bytes of memory for each 8-bit ADC input for the telescope detectors (4 detectors *  2 layers * 256 channels)
