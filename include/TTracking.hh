...
public:
	TTracking(std::string pathName, std::string alignmentName,UInt_t runNumber);
	...
	Float_t getMeasured(TPlane::enumCoordinate cor, UInt_t plane,TCluster::calculationMode_t mode);
