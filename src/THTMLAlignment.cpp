...
void THTMLAlignment::createPostDiamondOverview()
{
  ...
  sectionContent<<"For the diamond Alignment "<<nDiamondAlignmentEvents<<" of "<<nUsedEvents <<" ("<<setprecision(4)<<percentage<<"%) fullfill a  Chi2 cut at "<<alignment->getDiaChi2()<<".<br><br>\n";
  sectionContent<<"The diamond is aligned with a digital resoltuion convoluted with a gaus of "<<setprecision(4)<<alignment->getXResolution(4)*TPlaneProperties::getStripDistance()<<" &#956m";
