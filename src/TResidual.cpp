...
bool TResidual::operator==(TResidual& rhs)const{
    bool isSame = true;
    isSame = isSame && resXMean     == rhs.resXMean;
    isSame = isSame && resXSigma    == rhs.resXSigma;
    isSame = isSame && resYMean     == rhs.resYMean;
    isSame = isSame && resYSigma    == rhs.resYSigma;
    isSame = isSame && sumRy        == rhs.sumRy;
    isSame = isSame && sumVx        == rhs.sumVx;
    isSame = isSame && sumVy        == rhs.sumVy;
    isSame = isSame && sumV2x       == rhs.sumV2x;
    isSame = isSame && sumV2x       == rhs.sumV2x;
    isSame = isSame && sumVRx       == rhs.sumVRx;
    isSame = isSame && sumVRy       == rhs.sumVRy;
    isSame = isSame && nUsedTracks  == rhs.nUsedTracks;
    return isSame;
}
